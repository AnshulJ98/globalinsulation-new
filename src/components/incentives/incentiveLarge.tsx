  ...
  return (
    <>
     <div>
        ...
        <p className="pe-md-12 me-lg-12">Global Insulation: Your One-Stop Solution for All Insulation Needs!
</p>
        <div className="row mt-5">
          <div className="col-12 col-md-4">
            <div className="card shadow-xs border p-3 p-md-4 mb-4">
              ...
              <p className="opacity-8">From coast to coast, we've got you covered! Enjoy our top-notch services state-wide.</p>
            </div>
          </div>
          <div className="col-12 col-md-4 my-3 my-md-0">
            <div className="card shadow-xs border p-3 p-md-4 mb-4">
              ...
              <p className="opacity-8">We take pride in offering you peace of mind with a 100% Customer Satisfaction Guarantee for our professional services.</p>
            </div>
          </div>
          <div className="col-12 col-md-4">
            <div className="card shadow-xs border p-3 p-md-4 mb-4">
              ...
              <p className="opacity-8">You can rely on the experience of our highly skilled team all your insulation needs.</p>
            </div>
          </div>
        </div>
      </div>
