    ...
    <>
      <a href={url}>
        <div className={`card card-background align-items-start mb-4 mb-lg-0 ${classList}`}>
          <div className="full-background" style={{backgroundImage: `url(${`${import.meta.env.BASE_URL}${thumb_src}`})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat'}}></div>
          <div className={`card-body ${classBody}`}>
            <div className="d-block mt-10">
              ...
              {/* {(cta != null) &&  */}
                <a href={url} className="text-white text-sm font-weight-semibold mb-0">See products &#62;</a>  
              {/* } */}
            </div>
          </div>
        </div>
